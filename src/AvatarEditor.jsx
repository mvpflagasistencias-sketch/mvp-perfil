...
const OPCIONES = {
  ...
  accesorios: ['none', 'variant01', 'variant02', 'variant03'], // Mapeado correcto para lentes/parches
...
const AvatarEditor = ({ jugadorId, configInicial, onGuardarExito }) => {
  ...
  const obtenerDataUriAvatar = () => {
    try {
      ...
      // 🚀 SOLUCIÓN EN ACCESORIOS: Pasamos la opción seleccionada tanto a la clave 'features' como a 'featuresProbability'
